...
@section('main')
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <form id="pd-builder-form" action="/brands" class="tab-content">
                            <input type="hidden" name="token" value="{{csrf_token()}}">
                            <div id="step1" class="form-group panel panel-info tab-pane fade in active">
                                <div class="panel-heading">
                                    <p>Ingresá el nombre de la nueva marca.</p>
                                </div>
                            ...
                            <br>
                            <button type="submit" class="btn btn-default">Cargar nueva marca</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="{{asset('js/brand/create.js')}}">
