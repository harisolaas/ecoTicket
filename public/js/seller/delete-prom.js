;(function (window,document,undefined)
{
    ...
    {
        var forms = document.querySelectorAll('[data-form=promotion-delete]')
        ...
        function sendForm(form, callback)
        {
            ...
            req.open('POST', '/seller/promotion/delete')
        ...
        forms.forEach(function (form)
        {
            ...
            {
                e.preventDefault()
                if (window.confirm('ADVERTENCIA: Esta es una operación destructiva. ¿Desea seguir adelante?')) {
